export const dataSX = [
{
    ...
    childs: [{
        id: 10201,
        name: '业绩总览与统计',
        url: '/sale/performance/shanxi/list',
        roleRequired: 'CustomerService',
    }, /*{
        id: 10202,
        name: '客户转移记录',
...
}, 
{
    ...
    childs: [{
        id: 10501,
        name: '售电合约管理',
        url: '/sale/contracts/shanxi/list',
        roleRequired: 'SellerAgent,CustomerService',
    }, {
        id: 10502,
        name: '售电合约执行',
        url: '/sale/contractexecute/shanxi/list',
        roleRequired: 'CustomerService',
    }, {
        id: 10503,
        name: '售电合约文本管理',
        url: '/sale/contractkeep/shanxi/list',
        roleRequired: 'SellerAgent,CustomerService',
    }, {
        id: 10504,
        name: '售电合约统计分析',
        url: '/sale/contractkeep/shanxi/report',
        roleRequired: 'SellerAgent,CustomerService',
    }
    ]
}, {
    ...
    childs: [{
        id: 10601,
        name: '采购计划管理',
        url: '/purchase/plan/shanxi/list',
        roleRequired: 'CustomerService',
    }, {
        id: 10602,
        name: '采购执行',
        url: '/purchase/execute/shanxi/list',
        roleRequired: 'CustomerService,Purchaser',
    // }, {
    //     id: 10603,
    //     name: '购电合约管理', //山西没有采购合约
    //     url: '/',
    //     roleRequired: 'CustomerService,Purchaser',
    }, {
        id: 10604,
...
}, 
{
    ...
    childs: [{
        id: 10701,
        name: '结算明细',
        url: '/settlement/purchase/shanxi/list',
        roleRequired: 'FinancialOfficer',
    }
    ]
}, 
