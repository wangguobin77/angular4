export const dataGD = [
{
    ...
    childs: [{
        id: 10201,
        name: '业绩总览与统计',
        url: '/sale/performance/guangdong/list',
        roleRequired: 'CustomerService',
    }, /*{
        id: 10202,
        name: '客户转移记录',
...
}, 
{
    ...
    childs: [{
        id: 10101,
        name: '电力客户',
        url: '/client/guangdong/list',
        roleRequired: 'SellerAgent,CustomerService',
    }, 
    {
        id: 10102,
        name: '客户统计分析',
        url: '/client/Performancegd',
        roleRequired: 'SellerAgent,CustomerService',
    }, 
    //{
    //     id: 10103,
    ...
    childs: [{
        id: 10501,
        name: '售电合约管理',
        url: '/sale/contracts/guangdong/list',
        roleRequired: 'SellerAgent,CustomerService',
    }, {
        id: 10502,
        name: '售电合约执行',
        url: '/sale/contractexecute/guangdong/list',
        roleRequired: 'CustomerService',
    }, {
        id: 10503,
        name: '售电合约文本管理',
        url: '/sale/contractkeep/guangdong/list',
        roleRequired: 'SellerAgent,CustomerService',
    }, 
    {
        id: 10504,
        name: '售电合约统计分析',
        url: '/sale/contractkeep/guangdong/report',
        roleRequired: 'SellerAgent,CustomerService',
    }
    ]
}, {
    ...
    childs: [{
        id: 10601,
        name: '采购计划管理',
        url: '/purchase/plan/guangdong/list',
        roleRequired: 'CustomerService',
    }, {
        id: 10602,
        name: '采购执行',
        url: '/purchase/execute/guangdong/list',
        roleRequired: 'CustomerService,Purchaser',
    }, {
        id: 10603,
        name: '购电合约管理',
        url: '/purchase/contract/guangdong/list',
        roleRequired: 'CustomerService,Purchaser',
    }, {
        id: 10604,
        name: '合作电厂管理',
    ...
    childs: [{
        id: 10701,
        name: '结算明细',
        url: '/settlement/purchase/guangdong/list',
        roleRequired: 'FinancialOfficer',
    }
    ]
}, 
