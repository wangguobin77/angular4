...
@Component({
    ...
    selector: 'Performancesx',

    templateUrl: './performancesx.component.html',

    styleUrls: ['./performance.scss']

})

export class Performancesx{
    ...
    ngOnInit(authSvc: AuthService) {
     ...
     //信息的读取
        ...
        //let Info = `api/CustomerCountAndAnalysisSX/GetCustomerCountInfo/`;

        //let totalInfo = `${environment.sellerCRMApi}${Info}`;

        let totalInfo=`${environment.sellerCRMApi}api/CustomerCountAndAnalysisSX/GetCustomerCountInfo`;
