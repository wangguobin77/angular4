...
export abstract class NorthService extends BehaviorSubject<GridDataResult> implements OnDestroy {
    private BASE_URL = `${environment.sellerCRMApi}api/Customer/GetCustomerContacts/`;
...
@Injectable()
export class ContactService extends NorthService {
