...
@Component({
  ...
  template: `<div class="content-box">
				<div class="pageTitle">
					...
					<a class="a-button-xian a-button-xian-grey float-r ma-r20 ma-t10" [routerLink]="['/client/guangdong']">返回</a>
				</div>
				<div class="customer-table">
			        <a class="" name="0" [routerLink]="['/client/guangdong/customergd',routeId]">客户首页</a>
			        <a class="" [ngClass]="{active: !isSale}" name="1" [routerLink]="['/client/guangdong/detail/client',routeId]">客户档案</a>
			        <a class="" [ngClass]="{active: isSale}" name="2"  [routerLink]="['/client/guangdong/detail/sale',routeId]">销售信息</a>
