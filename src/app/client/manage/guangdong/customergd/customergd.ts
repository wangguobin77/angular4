...
@Component({
    selector: 'customergd',
    templateUrl: './customergd.html',
    styleUrls: ['./customer.scss']
})
export class customergd implements OnDestroy{
    sub1;
    public data={};
    public basicInfo = {};
        ...
        function createChart1() {
            ...
            $("#chart1").kendoChart({
                      ...
                      transport: {
                        read: function (f) {
                            ...
                            .subscribe((res) => {
                               ...
                               f.success(result1.CustomerContractList);
                            })
                ...
                series: [{
                 ...
                 {
                    field: "deviationPunishAmountDisplay",
                    name: "客户承担偏差",
                    color:'#5EA5F5'
                },{
                    field: "companyPunishAmount",
                    name: "公司承担偏差",
                    color:'#00CC99'
                }],
                valueAxis: {
