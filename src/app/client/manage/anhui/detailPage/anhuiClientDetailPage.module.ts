...
@Component({
        ...
        template: `<div class="content-box">
            <div class="pageTitle">
                <i class="iconfont icon-guanxiaobaotubiao16"></i>电力客户
                <a [routerLink]="['/client/anhui/detail/client',pageId]" class="a-button-xian a-button-xian-grey float-r ma-r20 ma-t10">返回</a>
            </div>
...
export class DetailAPageModule{}