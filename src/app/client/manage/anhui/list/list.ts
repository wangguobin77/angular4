...
export class AnhuiList implements OnInit, OnDestroy {
    ngAfterViewInit(){
        $.showSide(10101);
    }
    ...
    constructor(public service: DataService, private auth: AuthHttpService,private route: ActivatedRoute,private router: Router, ) {
        this.view = service;
    ...
    getProvince() {
        const getProvinceUrl = `${environment.sellerCRMApi}api/Customer/GetProvince`;
