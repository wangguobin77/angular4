...
@Component({
  ...
  template: `<div class="content-box">
				<div class="pageTitle">
					...
					<a class="a-button-xian a-button-xian-grey float-r ma-r20 ma-t10" [routerLink]="['/client/anhui']">返回</a>
				</div>
				<div class="customer-table">
			        <a class="" name="0" [routerLink]="['/client/anhui/customer',routeId]">客户首页</a>
			        <a class="" [ngClass]="{active: !isSale}" name="1" [routerLink]="['/client/anhui/detail/client',routeId]">客户档案</a>
			        <a class="" [ngClass]="{active: isSale}" name="2"  [routerLink]="['/client/anhui/detail/sale',routeId]">销售信息</a>
