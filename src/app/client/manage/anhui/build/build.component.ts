...
export class AnhuiBuild implements OnInit, OnDestroy {
    ...
    sendTotleData() {
        ...
        const totleUrl = `${environment.sellerCRMApi}api/Customer/CreateCustomerforApi/`;
    ...
    getSaleUser() {
        const citiesUrl = `${environment.sellerCRMApi}api/Customer/GetSalesList`;
