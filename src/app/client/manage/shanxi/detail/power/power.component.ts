...
export class Power implements AfterViewInit, OnDestroy {
    ...
    removeHandler({ dataItem }) {
        this.sub1 = this.auth.post(`${environment.sellerCRMApi}api/CustomerSX/RemoveCustomElectricity`, { id: dataItem.id })
            .subscribe((res) => {
    ...
    onSave(m) {
        ...
        this.sub2 = this.auth.post(`${environment.sellerCRMApi}api/CustomerSX/ModifyCustomElectricity`, postData)
            .subscribe((res) => {
