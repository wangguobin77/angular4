...
export class LicenseUpload implements OnInit, OnDestroy {
    ...
    onSubmit() {
        this.sub1 = this.auth.post(`${environment.sellerCRMApi}api/CertSX/SaveCert/`, this.licenseData)
            .subscribe((res) => {
    ...
    ngOnInit() {
        ...
        this.sub2 = this.auth.get(`${environment.sellerCRMApi}api/CertSX/CertEdit/?sellerSubjectId=${this.pageId}`)
            .subscribe((res) => {
