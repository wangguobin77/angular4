...
export class ContractDetail implements OnDestroy{
    sub1;
	...
	ngOnInit(){
        ...
        this.sub1=this.auth.get(`${environment.sellerEnergyPurchaseApi}api/AHEnergyContract/GetDetail/${id}`).subscribe( (res) =>{
            let result = res.json();
