...
_the.sub1=_the.authService.AuthGet(`${environment.sellerContractApi}api/GDContractOverview/GetData`, ).subscribe(function (res) {
            ...
            dataSource: {
                transport: {
                    read: function (f) {
                        ...
                        paras.params = f.data;
                        _the.sub2=_the.authService.AuthGet(`${environment.sellerContractApi}api/GDContractOverview/GetContrant`,f.data).subscribe(function (res) {
                            f.success(res.json());
                        });
                    }
                },
