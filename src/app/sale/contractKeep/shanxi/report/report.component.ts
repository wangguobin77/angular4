...
_the.sub1=_the.authService.AuthGet(`${environment.sellerContractApi}api/SXContractOverview/GetData`, ).subscribe(function (res) {
        ...
        $("#grid").kendoGrid({
            dataSource: {
                transport: {
                    read: function (f) {
                        ...
                        paras.params = f.data;
                        _the.sub2=_the.authService.AuthGet(`${environment.sellerContractApi}api/SXContractOverview/GetContrant`,f.data).subscribe(function (res) {
                            f.success(res.json());
                        });
                    }
                },
            ...
            columns: [
                ...
                { field: "TotalLong", title: "长协电量<br />(万千瓦时)",template:"--" },
