    ...
    ngOnInit() {
        ...
        $("#years").kendoDropDownList({
            ...
            dataSource: {
                transport: {
                   read: function (f) {
                        this.sub1=_this.authService.AuthGet(`${environment.sellerContractApi}api/GDPowerDistribution/GDContractExecuteYear`).subscribe(function (res) {
                            f.success(res.json());
                        });
                    }
                }
            ...
            dataSource: {
                transport: {
                    read: function (f) {
                        ...
                        this.sub1=_this.authService.AuthGet(`${environment.sellerContractApi}api/GDPowerDistribution/GDGetPurchasePlan`, f.data).subscribe(function (res) {
                            f.success(res.json());
                        });
                    }
                },
        ...
        $("#grid").off("click", "a.color-exactGreen").on("click", "a.color-exactGreen", function () {
            ...
            _this.router.navigate([`/sale/contractexecute/guangdong/edit/${date}`]);
        });
