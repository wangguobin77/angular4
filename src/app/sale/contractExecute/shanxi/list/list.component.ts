    ...
    ngOnInit() {
        ...
        $("#years").kendoDropDownList({
            ...
            dataSource: {
                transport: {
                    read: function (f) {
                        this.sub1=_this.authService.AuthGet(`${environment.sellerContractApi}api/SXPowerDistribution/SXContractExecuteYear`).subscribe(function (res) {
                            f.success(res.json());
                        });
                    }
                }
        ...
        $("#grid").kendoGrid({
            dataSource: {
                transport: {
                    read: function (f) {
                        ...
                        this.sub1=_this.authService.AuthGet(`${environment.sellerContractApi}api/SXPowerDistribution/SXGetPurchasePlan`, f.data).subscribe(function (res) {
                            f.success(res.json());
                        });
                    }
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    template: function (dataItem) {
                        if (dataItem.LongActualUsedAmount != 0) {
                ...
                },
                {
                    ...
                    template: function (dataItem) {
                        if (dataItem.BidActualPurchaseAmount != 0 ) {
        ...
        $("#grid").off("click", "a.color-exactGreen").on("click", "a.color-exactGreen", function () {
            ...
            _this.router.navigate([`/sale/contractexecute/shanxi/edit/${date}`]);
        });
