...
export class EditComponent implements OnDestroy{
    ...
    submit(e) {
        ...
        this.sub10=the.authService.AuthPost(`${environment.sellerContractApi}api/Common/SubmitPackageData`, the.packageModel.data).subscribe((res)=> {
            ...
            this.sub11=the.authService.AuthPost(`${environment.sellerContractApi}api/AHContract/AddOrUpdateContract`, request).subscribe((msg)=> {
                //let msg = res.json();
                //alert(msg.);
    ...
    ngOnInit() {
        ...
        this.sub12=this.authService.AuthGet(`${environment.sellerContractApi}api/AHContract/GetContractDetail/${id}`).subscribe((res) =>{
            let m = res.json();
            let the = this.model;
