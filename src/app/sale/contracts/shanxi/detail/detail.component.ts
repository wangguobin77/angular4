...
export class DetailComponent implements OnDestroy {
    ...
    ngOnInit() {
        ...
        __this.historyUrl = `/sale/contracts/shanxi/history/${id}`;

        //var id = 2;
        this.sub1=this.authService.AuthGet(`${environment.sellerContractApi}api/SXContract/GetContractDetail/` + id).subscribe( (res) =>{
            let result = res.json();
            this.model = result;
            ...
            __this.model.contracts.IsPark = (__this.model.contracts.sellerParkId!=null);
