...
export class HistoryComponent implements OnDestroy {
    ...
    submit(e) {
        ...
        this.sub1=_this.authService.AuthPost(`${environment.sellerContractApi}api/SXContract/UpdateBidPlanAmount`, _this.bidAmountModel).subscribe(function (res) {
            //let msg = res.json();
            //alert(msg.);
            _this.refresh();
        });
    ...
    ngOnInit() {
        ...
        _this.detailUrl = `/sale/contracts/shanxi/detail/${id}`;
        ...
        //合约概况
        this.sub2=_this.authService.AuthGet(`${environment.sellerContractApi}api/SXContract/GetContractInfo/${id}`).subscribe(function (res) {
        ...
        let loadGrid = function () {
            ...
            $("#grid").kendoGrid({
                dataSource: {
                    transport: {
                        read: function (f) {
                            this.sub3=_this.authService.AuthGet(`${environment.sellerContractApi}api/SXContract/GetContractPlans/${id}`).subscribe(function (res) {
                                f.success(res.json());
                            });
                        }
                    },
