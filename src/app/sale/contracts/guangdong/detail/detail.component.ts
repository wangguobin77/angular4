...
export class DetailComponent implements OnDestroy {
    ...
    ngOnInit() {
        ...
        __this.historyUrl = `/sale/contracts/guangdong/history/${id}`;

        //var id = 2;
        this.sub1=this.authService.AuthGet(`${environment.sellerContractApi}api/GDContract/GetContractDetail/` + id).subscribe( (res) =>{
            let result = res.json();
            this.model = result;
