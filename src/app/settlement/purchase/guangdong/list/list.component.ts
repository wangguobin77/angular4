...
; (function () {
    win.tcId = 6; //$("#hdTc").val();
    win.tcName = "广东交易中心";//$("#hdTc").prop("name");
    ...
    var _filter = {
        ...
        search: function () {
            var _this = this;
            the.sub1=the.authService.AuthGet(`${api}gdpurchasesettlement/getreport/${_this.data.year}`).subscribe((res)=> {
                let data = res.json();
                win.initChart(data);
        ...
        load: function () {
            ...
            $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "punishDisplay", title: "偏差惩罚<p>(元)</p>" },
                    { field: "profitsDisplay", title: "公司净收益<p>(元)</p>" },
...
; (function () {
    var _settle = {
        ...
        add: function () {
            ...
            the.sub2=the.authService.AuthPost(`${api}gdpurchasesettlement/addsettlement/`, input).subscribe((res)=> {
                alert("结算成功");
                win.refresh();
        ...
        load: function () {
            ...
            the.sub3=the.authService.AuthPost(`${api}gdpurchasesettlement/opensettlement/`, _settle.data.open).subscribe((res)=> {
                let data = res.json();
...
; (function () {
    var _settle = {
        ...
        load: function () {
            ...
            the.sub4=the.authService.AuthGet(`${api}gdpurchasesettlement/lookvouchers/`, _settle.data.open).subscribe((res)=> {
                let data = res.json();
...
; (function () {
    ...
    var _settle = {
        ...
        add: function () {
            ...
            the.sub5=the.authService.AuthPost(`${api}gdpurchasesettlement/addsettlement/`, input).subscribe((res)=> {
                alert("结算成功");
                win.refresh();
                $("#endDialog").data("kendoDialog").close();
            });
        ...
        load: function () {
            ...
            the.sub6=the.authService.AuthPost(`${api}gdpurchasesettlement/opensettlement/`, _settle.data.open).subscribe((res)=> {
                let data = res.json();
                _settle.data.opened = data;
                var unPaid = kendo.toString(data.unPaidPrice, "n");
